...
function insert($name, $desk, $year, $rating, $poster, $category_id) {
	...
	$query = "INSERT INTO movie VALUES(null, '$name', '$desk', '$year', '$rating', '$poster', Now(), '$category_id')";
...
$xml = simplexml_load_file("xml/movies.xml") or die("Error: Cannot create an object");
